...
ggsave("results/Clustering/figures/integrated/QC/resolution_0.4/UMAP_clusters_seurat.png", plot = UMAP_clusters_seurat, width = 10, height = 10, limitsize = FALSE)
...
ggsave("results/Clustering/figures/integrated/QC/resolution_0.4/cells_per_cluster_barplot.png", plot = cells_per_cluster_barplot, width = 55, height = 10, limitsize = FALSE)


# UMAP of cells in each cluster by sample
UMAP_cluster_split_by_sample <- DimPlot(seurat_integrated, label = TRUE, split.by = "sample")  + NoLegend()
ggsave("results/Clustering/figures/integrated/QC/resolution_0.4/UMAP_cluster_split_by_sample.png", plot = UMAP_cluster_split_by_sample, width = 40, height = 10, limitsize = FALSE)
...
ggsave("results/Clustering/figures/integrated/QC/resolution_0.4/UMAP_cell_cycle_phase.png", plot = UMAP_cell_cycle_phase, width = 40, height = 20, limitsize = FALSE)
...
ggsave("results/Clustering/figures/integrated/QC/resolution_0.4/cell_proportion_barplot.png", plot = cell_proportion_barplot, width = 20, height = 10, limitsize = FALSE)
...
ggsave("results/Clustering/figures/integrated/QC/resolution_0.4/feature_plot.png", plot = feature_plot, width = 25, height = 30, limitsize = FALSE)


PCA_group_by_sample <- PCAPlot(seurat_integrated, group.by = "sample")
ggsave("results/Clustering/figures/integrated/QC/resolution_0.4/PCA_group_by_sample.png", plot = PCA_group_by_sample, width = 15, height = 15, limitsize = FALSE)


PCA_split_by_sample <- PCAPlot(seurat_integrated, split.by = "sample")
ggsave("results/Clustering/figures/integrated/QC/resolution_0.4/PCA_split_by_sample.png", plot = PCA_split_by_sample, width = 40, height = 10, limitsize = FALSE)


# Boxplot of nGene per cluster
nGene_per_cluster <- ggplot(seurat_integrated@meta.data) +
  geom_boxplot(aes(x=integrated_snn_res.0.4, y=nGene, fill=integrated_snn_res.0.4)) + NoLegend()
ggsave("results/Clustering/figures/integrated/QC/resolution_0.4/nGene_per_cluster.png", plot = nGene_per_cluster, width = 40, height = 15, limitsize = FALSE)


# Boxplot of mitoRatio per cluster
mitoRatio_per_cluster <- ggplot(seurat_integrated@meta.data) +
  geom_boxplot(aes(x=integrated_snn_res.0.4, y=mitoRatio, fill=integrated_snn_res.0.4)) + NoLegend()
ggsave("results/Clustering/figures/integrated/QC/resolution_0.4/mitoRatio_per_cluster.png", plot = mitoRatio_per_cluster, width = 40, height = 15, limitsize = FALSE)
...
UMAP_of_each_PC <- map(paste0("PC_", 1:16), function(pc){
  ...
  plot_grid(plotlist = .)
ggsave("results/Clustering/figures/integrated/QC/resolution_0.4/UMAP_of_each_PC.png", plot = UMAP_of_each_PC, width = 30, height = 40, limitsize = FALSE)
...
ggsave("results/Clustering/figures/integrated/QC/resolution_0.4/UMAP_no_legend.png", plot = UMAP_no_legend, width = 10, height = 10, limitsize = FALSE)
