# Single-cell RNA-seq - differential gene expression analysis
...
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876198_COL07_CRC"))] <- "CRC"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876199_COL07_LM"))] <- "LiverMet"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876200_COL12_CRC"))] <- "CRC"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876201_COL12_LM"))] <- "LiverMet"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876202_COL12_PBMC"))] <- "PBMC"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876203_COL15_CRC"))] <- "CRC"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876204_COL15_LM"))] <- "LiverMet"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876205_COL16_CRC"))] <- "CRC"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876206_COL16_LM"))] <- "LiverMet"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876207_COL17_CRC"))] <- "CRC"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876208_COL17_LM"))] <- "LiverMet"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876209_COL17_PBMC"))] <- "PBMC"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876210_COL18_CRC"))] <- "CRC"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876211_COL18_LM"))] <- "LiverMet"
seurat_annotated$tissue[which(str_detect(seurat_annotated$cells, "SAMN18876212_COL18_PBMC"))] <- "PBMC"

seurat_annotated$sex <- NA
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876198_COL07_CRC"))] <- "M"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876199_COL07_LM"))] <- "M"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876200_COL12_CRC"))] <- "M"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876201_COL12_LM"))] <- "M"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876202_COL12_PBMC"))] <- "M"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876203_COL15_CRC"))] <- "F"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876204_COL15_LM"))] <- "F"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876205_COL16_CRC"))] <- "M"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876206_COL16_LM"))] <- "M"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876207_COL17_CRC"))] <- "F"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876208_COL17_LM"))] <- "F"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876209_COL17_PBMC"))] <- "F"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876210_COL18_CRC"))] <- "M"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876211_COL18_LM"))] <- "M"
seurat_annotated$sex[which(str_detect(seurat_annotated$cells, "SAMN18876212_COL18_PBMC"))] <- "M"

seurat_annotated$single_cell_chemistry <- NA
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876198_COL07_CRC"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876199_COL07_LM"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876200_COL12_CRC"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876201_COL12_LM"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876202_COL12_PBMC"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876203_COL15_CRC"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876204_COL15_LM"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876205_COL16_CRC"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876206_COL16_LM"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876207_COL17_CRC"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876208_COL17_LM"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876209_COL17_PBMC"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876210_COL18_CRC"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876211_COL18_LM"))] <- "10X_v2"
seurat_annotated$single_cell_chemistry[which(str_detect(seurat_annotated$cells, "SAMN18876212_COL18_PBMC"))] <- "10X_v2"
...
metadata <- colData(sce) %>% 
  as.data.frame() %>% 
  dplyr::select(sample_id, tissue, sex, single_cell_chemistry)
...
# Run the script on all clusters comparing conditions relative
results_summary <- map(cluster_names, get_dds_resultsAvsB, A = "LiverMet", B = "CRC")
